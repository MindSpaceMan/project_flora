...
final class FlowerTestFixtures extends Fixture
{
    ...
    {
        $eustomaCare = '•   Место посадки: солнечное или полутень, без сильных сквозняков.
                        •	Почва: лёгкая, рыхлая, дренированная, с нейтральной кислотностью.
                        •	Полив: регулярный, но умеренный — избегать переувлажнения.
                        •	Температура: оптимально +20…+25 °C. Не переносит холодные ночи.
                        •	Подкормка: каждые 2 недели комплексное удобрение для цветущих растений.
                        •	Пересадка: плохо переносит, лучше сразу сажать на постоянное место.
                        •	Особое: не любит застой влаги и скопление воды у корней.';
        $tulipCare    ='•   Место посадки: солнечное, защищённое от сильных ветров.
                        •	Почва: лёгкая, плодородная, хорошо дренированная, pH нейтральный.
                        •	Посадка: осенью (сентябрь–октябрь), глубина — 2–3 высоты луковицы.
                        •	Полив: после посадки — обильный. Весной — по мере подсыхания почвы.
                        •	Подкормка: весной азотные удобрения, во время бутонизации — калий и фосфор.
                        •	После цветения: не обрезать листья сразу, ждать пожелтения (питание для луковицы).
                        •	Хранение луковиц: летом выкапывают, сушат и хранят в сухом прохладном месте.';
        ...
        foreach ($items as $i => $row) {
            ...
            switch ($row['category']) {
                case 'eustomy':
                    $product->setCareMessage($eustomaCare);
                    break;
                case 'tulip':
                    $product->setCareMessage($tulipCare);
                    break;
            }
